...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20211208_askventure_49ca3eb9658494875510_20211211022332_archive.zip';
	const ARCHIVE_SIZE		 = '48578203';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '49ca3eb-11022332';
    const SECONDARY_PACKAGE_HASH = 'b9cedb5-11022332';
	const VERSION			 = '1.4.3';
